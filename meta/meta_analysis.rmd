...
# Polish the output with appropriate seed and pcartitioning
...
getCenters(meta)[ ,c('name', 'membership', 'size')]
...
vl <- getCenters(meta)[ ,c('name', 'membership', 'type')]
...
meta <- applyAlternation(meta)
ida <- grep('>id|idx|step', getCenters(meta)$name, value=TRUE)
