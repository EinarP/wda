...
tbl <- rbind(
  ...
  c('O=id', 'O>id',	'NA', 'NA', 'O', 'NA', 'NA', '(id)', 'NA'),
  c('O>P=V', 'O',	'P', 'V', 'O', 'NA', 'P', 'NA', 'V'),
  c('O=id>P=V', 'O>id', 'P', 'V', 'O', 'NA', 'P', '(id)', 'V'),
  c('O>P>V=V2', 'O>P', 'V', 'V2', 'O', 'NA', 'P', 'V', 'V2'),
  c('O|O2', 'O>id|O2', 'type', 'weak', 'O', 'O2', 'id', 'type', 'weak'),
  c('O>P|O2', 'O>P|O2', 'type', 'weak', 'O', 'O2', 'P', 'type', 'weak'),
  c('O|O2=V', 'O>id|O2', 'type', 'weak', 'O', 'O2', 'id', 'type', 'weak'),
  c('O>P|O2=V', 'O>P|O2', 'type', 'V', 'O', 'O2', 'P', 'type', 'V'),
  c('O|O2>P2=V', 'O>id|O2', 'P2', 'V', 'O', 'O2', 'id', 'P2', 'V'),
  c('O>P|O2>P2=V', 'O>P|O2', 'P2', 'V', 'O', 'O2', 'P', 'P2', 'V')
)
...
Helper fields *h_* will be added for observations table for convinience. Current notation supports on entity level only *id* meta property and stores the *id* value itself in h_meta column
...
(meta <- grow(meta, 'OBSERVATION', depth = 1, width = 0) %>% grow('SEQUENCE', width = 2) %>% 
   applyPartitioning('mbrp') %>% applySeed(417))
```
