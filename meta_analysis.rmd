...
ggplot(s, aes(x=count, fill=type)) + stat_count(width=0.8, position='dodge') +
  ...
  geom_text(aes(x=0.5, label='baseline', y=100), hjust=-0.1, color=col, size=5) +
  geom_vline(aes(xintercept=3.5), color=col, linetype=lt, size=1) +
  geom_text(aes(x=3.5, label='checkpoint 1', y=100), hjust=-0.1, color=col, size=5) +
  geom_vline(aes(xintercept=5.5), color=col, linetype=lt, size=1) +
  geom_text(aes(x=5.5, label='checkpoint 2', y=100), hjust=-0.1, color=col, size=5)
```
