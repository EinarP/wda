...
anobj <- applySeed(sq=anobj, seed=99)
anobj
...
ganobj <- group(ganobj, gname, gmbr)
ganobj

sanobj <- applySeed(anobj, 678)
sanobj <- doScaling(sq=sanobj, scaling=3)
sanobj

# Add relevant details
sizobj <- applySeed(anobj, 166)
...
applyLayout(sq=anobj, layout="layout_on_grid")
