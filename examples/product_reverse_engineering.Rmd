...
NAV <- read_excel('../data/fp.xlsx', sheet='prices')
...
drops <- colnames(fp_ret['2008',is.na(fp_ret['2008'])])
...
# Discussion
Naïve analysis: Risk management
...
arc3 <- fp_ret_corr[ ,c("XMWO", "TEMTACU", "PIMGIIA")]
