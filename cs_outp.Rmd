...
```
It is impossible and wasteful to anticipate every possible property and statistic which might be needed in later analysis. Therefore, the observations were arranged in flexible object-property-value format. This time the following properties and samples were collected:
...
For making sense of the data is reasonable to convert it to a “wide format”. Below this is achieved by using the helper functions developed for structural analysis and which will be discussed later. Please also note the total number of observations:
...
Now we have prepared all the data for the summary plot:
